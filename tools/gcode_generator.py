...
gcode = open(os.path.join(root, "gcodes", "demo_pattern.txt"), "w", newline="\n")
...
gcode.write('G90\n')
gcode.write('M83\n')
#gcode.write('SET_GCODE_OFFSET Z=0.03\n')
gcode.write('M221 S100\n')
gcode.write(
...
for i in range(cfg.lines):
    ...
    gcode.write(f'G1 X{x_i} Y{y_0} F{cfg.travel_speed * 60}\n')
    gcode.write('G11\n')
